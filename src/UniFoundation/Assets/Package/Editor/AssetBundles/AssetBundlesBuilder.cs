using JoyfulWorks.UniFoundation.AssetBundles;
using System;
using System.IO;
using System.Linq;
using UnityEditor;
...
namespace JoyfulWorks.UniFoundation.Editor.AssetBundles
{
    public class AssetBundlesBuilder : EditorWindow
    {
        ...
        //Templates
        private const string WindowTemplatePath = "AssetBundlesBuilder.uxml";
        private VisualTreeAsset windowTemplate;
    
        //Styles
        private const string StyleSheetPath = "AssetBundlesBuilder.uss";
